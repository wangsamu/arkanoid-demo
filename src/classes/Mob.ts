import mob00 from "../img/mob00.png";
import mob01 from "../img/mob01.png";
import mob02 from "../img/mob02.png";

import Brick from "./Brick";

class Mob {
  enemyList = [mob00, mob01, mob02];
  enemy;
  spriteWidth;
  spriteHeight;
  spawnPosX;
  ...
  constructor(enemy: number) {
    ...
    this.spawnPosX = this.getXPos();
    this.spawnPosY = this.getYPos();
  }
  getXPos() {
    const remainder = (320 - this.sprite.width * 6) / 2;
    return Math.floor(remainder);
  }
  getYPos() {
    const remainder = 240 - (this.sprite.height * 4 + 92);
    return remainder;
  }
